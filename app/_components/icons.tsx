...
// --- MASTER (platform administration) icon set ---
// Same convention as the icons above: functional component, fixed
// width/height, aria-hidden + focusable="false" baked in (these are
// always paired with visible text or an aria-label on their container).
...
export function UsersIcon({ className }: { className?: string }) {
  return (
    ...
    >
      ...
      <path d="M21.5 20c0-2.6-1.6-4.3-3.8-5" />
    </svg>
  );
}
...
export function ShieldIcon({ className }: { className?: string }) {
  return (
    <svg
      ...
      focusable="false"
    >
      <path d="M12 3l7 3v6c0 4-3 6.8-7 9-4-2.2-7-5-7-9V6z" />
    </svg>
  );
}
